...
<%     
    ...
    if(rs.next()) 
    {
       agentid=rs.getString(2);
       agentname=rs.getString(3);
...
<%    
    ...
    java.sql.Statement stmt=con.createStatement();  
    String ins="insert into bookedtickets(BTID,TICKETID,USERID,USERNAME,AGENTID,AGENTNAME,AGENTMOBNO,SHOPNAME,CATEGORY,TICKETNO,TIME,DATE,STATUS,TSTATUS,WINPRICE) values('"+bookedticketid+"','"+ticketid+"','"+userid+"','"+username+"','"+agentid+"','"+agentname+"','"+mobno+"','"+shopname+"','"+category+"','"+ticketno+"','"+date+"','"+time+"','pending','open','"+winprice+"')";
    String inss="update tickets set STATUS='sold_out' where TICKETID='"+ticketid+"' and AGENTID='"+agentid+"' ";
        ...
        <div class="form-41-mian pt-lg-4 pt-md-3 pb-md-4">
            <div class="container">
                <div class="heading text-center" style="padding-top: 8rem;">
                    <h3 class="category-title mb-3" style="color: limegreen;">Ticket Purchase Successfully !</h3>               
                </div>
                <div class="heading text-center pt-3">
                    <a href="index1.jsp" class="btn btn-primary">Buy another !</a>              
                </div>
            </div>
            <!-- //contacts-5-grid -->
        </div>
