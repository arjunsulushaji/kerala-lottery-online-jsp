        ...
        <div class="form-41-mian pt-lg-4 pt-md-3 pb-md-4">
            <div class="container">
                <div class="heading text-center">
                    <h3 class="category-title mb-3" style="color: #5a67d8;">Login</h3>               
                </div>
                <div class="row">
                    <div class="col-lg-8 form-inner-cont pt-3" style="margin-left: 1rem;">
                        <form action="loginnext.jsp" method="post" class="signin-form">

                            <div class="form-input pt-4">
                                <input type="email" name="useremail" id="w3lPhone" placeholder="Enter your Email *"
                                       required />
                            </div> 
                            <div class="form-input pt-4">
                                <input type="password" name="userpass" id="w3lPhone" placeholder="Enter your Password *"
                                       required />
                            </div>
                            <div class="text-right pt-3">
                                <a href="signup.jsp" style="color: #5a67d8; padding-right: 26rem;">Create an account ?</a>
