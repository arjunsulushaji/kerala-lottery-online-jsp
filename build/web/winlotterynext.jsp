<%
    ...
    session.setAttribute("bookedticketid",bookedticketid);
    %>
<!doctype html>
<html lang="en">
    <head>
        ...
        <div class="form-41-mian pt-lg-4 pt-md-3 pb-md-4">
            <div class="container">
                <div class="heading text-center">
                    <h3 class="category-title mb-3" style="color: #5a67d8;">Win Amount</h3>               
                </div>
                <div class="row">
                    <div class="col-lg-8 form-inner-cont pt-3" style="margin-left: 1rem;">
                        <form action="winlottery.jsp" method="post" class="signin-form">

                            <div class="form-input pt-4">
                                <input type="text" name="winamount" id="w3lPhone" placeholder="Enter win amount *"
                                       required />
                            </div>                             
                            <div class="text-right pt-3">                                
                                <button class="btn btn-style btn-primary" onclick="alert('Result updated successfull ! ')">Update</button>
                            </div>
                        </form>
                    </div>                
                </div>
