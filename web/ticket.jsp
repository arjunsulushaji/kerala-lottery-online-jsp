...
<html lang="en">
    ...
    <div class="w3l-contact-10" id="contact">
        <div class="form-41-mian pt-lg-4 pt-md-3 pb-md-4">
            <div class="container">
                <div class="heading text-center" style="padding-top: 3rem;">
                    <h5 class="category-title mb-3" style="color: var(--primary-color);">Avaliable Tickets</h5>               
                </div>
                ...
                <div class="heading text-center" style="padding-top: 3rem;">
                    <table class="table">
                        <thead>
                            <tr>
<!--                                <th scope="col">BOOKEDTICKET ID</th>                              -->
                                <th scope="col">AGENT NAME</th>
                                <th scope="col">AGENT MOB NO</th>
                      ...
                      java.sql.Connection con=java.sql.DriverManager.getConnection( "jdbc:mysql://localhost:3306/digital_lottery","root","");  
                      java.sql.Statement stmt=con.createStatement();  
                     String sele="SELECT *FROM bookedtickets where USERID='"+userid+"' order by BTID desc ";
                       java.sql.ResultSet rs=stmt.executeQuery(sele); 
                      while(rs.next()) 
                      {
...
<!--                                <td scope="row"></td>                                -->
                                ...
                                %>
                                <td style="color:limegreen;">Congratulations you win Rs : <%=rs.getString(15)%></td>
                                <%
                                    } else {
                                %>
                                <td style="color:red;">Better luck next time !</td>
                                <%
                                    }
                                %>
                            </tr> 
